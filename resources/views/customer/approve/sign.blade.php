...
<div class="container-fluid mb-5">
    ...
    <div class="card border-0 shadow-sm mb-4 bg-white d-print-none">
        <div class="card-body p-3 p-md-4 pt-4 pt-md-5 pb-3 pb-md-4">
            <div class="stepper-wrapper step-2 w-100 w-md-75 mx-auto">
            ...
            <div class="card-body p-3 p-md-5">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="mt-4 p-3 border border-primary border-opacity-25 rounded" style="background-color: var(--blue-soft, #f0f7ff);">
